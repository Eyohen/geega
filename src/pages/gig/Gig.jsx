...
function Gig() {
  ...
  const {isLoading, error, data, refetch} = useQuery({ 
    ...
    const {isLoading: isLoadingUser , error: errUser, data: dataUser} = useQuery({ 
      queryKey: ['user'],
      ...
      {isLoading ? "Loading" : error ? "Something went wrong!" : (  <div className="container">
        <div className="left">
          ...
          {isLoadingUser ? "Loading" : error ? "Something went wrong!" : (
             ...
             <div className="user">
               <img
                 src={dataUser?.image || "https://images.pexels.com/photos/720327/pexels-photo-720327.jpeg?auto=compress&cs=tinysrgb&w=1600"}
                 alt=""
               />
               <div className="info">

...
const Add = () => {
  ...
  //   queryKey: ['myGigs'],
  //    queryFn: () => newRequest.get(`/gigs?userId=${currentUser.id}`).then((res)=>{
  //     return res.data;
  //    }),
      ...
      <div className="container">
        ...
        <div className="sections">
          <div className="info">
            ...
            <select name="category" id="category" value={state?.category} onChange={handleChange}>
          ...
          <div className="details">
            ...
            <textarea
             name="shortDescription" id="" placeholder="Short description of your service"
             onChange={handleChange}
